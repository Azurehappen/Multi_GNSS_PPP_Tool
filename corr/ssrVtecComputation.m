function iono_corr = ssrVtecComputation(p,vtec_dict,re_pos,elev_rad,az_rad,gpst,rover_t,freq)
...
r_m = norm(re_pos);
[lat_ip, lon_ip, center_ang] = pierce_point_calc(p.lat,p.lon,az_rad,elev_rad,...
...
stec = vtec / sin(elev_rad + center_ang);
